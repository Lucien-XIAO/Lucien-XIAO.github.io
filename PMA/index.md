...
Le M2-PMA est fondamentalement l'un des programmes de Master 2 les plus solides en France pour les probabilités pures ou les processus stochastiques (l'autre étant le [M2 Mathématiques de l’aléatoire](https://www.universite-paris-saclay.fr/formation/master/mathematiques-et-applications/m2-mathematiques-de-laleatoire#programme) de l'Université Paris-Saclay ; bien sûr, nous ne pouvons pas ignorer la nouvelle force montante du M2 [MATH](https://dauphine.psl.eu/en/training/masters-degrees/mathematics-and-applied-mathematics/applied-and-theoretical-mathematics-masters-year-2) de l'Université Paris Dauphine-PSL). Ce M2 contient trois majeures : "Processus stochastiques", "Probabilités appliquées" et "EDProba”.
