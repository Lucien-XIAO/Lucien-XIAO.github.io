(function () {
  ...
  const TEXT_TRANSLATIONS = {
    ...
    "Campus courtyard": {
      en: "Campus courtyard",
      fr: "Cour intérieure du campus",
      zh: "校园庭院",
    },
    "photo.campus_courtyard.alt": {
      en: "Campus courtyard between modern buildings under a blue sky",
      fr: "Cour intérieure du campus entre des bâtiments modernes sous un ciel bleu",
      zh: "蓝天下现代建筑之间的校园庭院",
    },
    "Paris": {
      en: "Paris",
  ...
  const HTML_TRANSLATIONS = {
    "home.about.p1": {
      en: 'Beginning in October 2026, I will be a PhD student in mathematics at the <a href="https://lama-umr8050.fr/">LAMA</a>, <a href="https://www.univ-gustave-eiffel.fr/">Université Gustave Eiffel</a>. My doctoral project, <em>Interface Models in Mathematical Statistical Mechanics</em>, will be supervised by <a href="https://perso.math.u-pem.fr/leny.arnaud/" target="_blank">Arnaud Le Ny</a> (LAMA, <a href="https://www.u-pec.fr/">UPEC</a>) and <a href="https://perso.math.u-pem.fr/pmonmarc/" target="_blank">Pierre Monmarché</a> (LAMA, <a href="https://www.univ-gustave-eiffel.fr/">UGE</a>). The project lies at the intersection of probability theory, statistical mechanics, and ergodic theory. Previously, I was a student in the <a href="https://www.lpsm.paris/masters/modale/index">M2 Probabilités et Modèles Aléatoires</a> program at <a href="https://www.sorbonne-universite.fr/">Sorbonne Université</a>.',
      fr: 'À partir d’octobre 2026, je serai doctorant en mathématiques au <a href="https://lama-umr8050.fr/">LAMA</a>, à l’<a href="https://www.univ-gustave-eiffel.fr/">Université Gustave Eiffel</a>. Ma thèse, intitulée <em>Modèles d’interfaces en mécanique statistique mathématique</em>, sera dirigée par <a href="https://perso.math.u-pem.fr/leny.arnaud/" target="_blank">Arnaud Le Ny</a> (LAMA, <a href="https://www.u-pec.fr/">UPEC</a>) et <a href="https://perso.math.u-pem.fr/pmonmarc/" target="_blank">Pierre Monmarché</a> (LAMA, <a href="https://www.univ-gustave-eiffel.fr/">UGE</a>). Ce projet se situe à l’interface des probabilités, de la mécanique statistique et de la théorie ergodique. Auparavant, j’étais étudiant du <a href="https://www.lpsm.paris/masters/modale/index">M2 Probabilités et Modèles Aléatoires</a> à <a href="https://www.sorbonne-universite.fr/">Sorbonne Université</a>.',
      zh: '自 2026 年 10 月起，我将在 <a href="https://www.univ-gustave-eiffel.fr/">Université Gustave Eiffel</a> 的 <a href="https://lama-umr8050.fr/">LAMA</a> 攻读数学博士。我的博士课题为<em>数学统计力学中的界面模型</em>，由 <a href="https://perso.math.u-pem.fr/leny.arnaud/" target="_blank">Arnaud Le Ny</a>（LAMA，<a href="https://www.u-pec.fr/">UPEC</a>）和 <a href="https://perso.math.u-pem.fr/pmonmarc/" target="_blank">Pierre Monmarché</a>（LAMA，<a href="https://www.univ-gustave-eiffel.fr/">UGE</a>）共同指导。该课题位于概率论、统计力学与遍历理论的交叉方向。此前，我是 <a href="https://www.sorbonne-universite.fr/">Sorbonne Université</a> <a href="https://www.lpsm.paris/masters/modale/index">M2 Probabilités et Modèles Aléatoires</a> 项目的学生。',
    },
    "home.about.p2": {
      en: 'I have been fortunate to take part in several research projects, including the long-range Ising model with <a href="https://perso.math.u-pem.fr/leny.arnaud/">Arnaud Le Ny</a>, bi-Lipschitz equivalence of separated nets in Banach spaces with <a href="https://www.alexandroseskenazis.com/">Alexandros Eskenazis</a>, and collective motion modeling with <a href="https://sites.google.com/site/dianepeurichard/home">Diane Peurichard</a>.',
      fr: 'J’ai eu la chance de participer à plusieurs projets de recherche, notamment sur le modèle d’Ising à longue portée avec <a href="https://perso.math.u-pem.fr/leny.arnaud/">Arnaud Le Ny</a>, l’équivalence bi-lipschitzienne de réseaux séparés dans les espaces de Banach avec <a href="https://www.alexandroseskenazis.com/">Alexandros Eskenazis</a>, et la modélisation du mouvement collectif avec <a href="https://sites.google.com/site/dianepeurichard/home">Diane Peurichard</a>.',
      zh: '我有幸参与多个研究项目，包括与 <a href="https://perso.math.u-pem.fr/leny.arnaud/">Arnaud Le Ny</a> 研究长程 Ising 模型、与 <a href="https://www.alexandroseskenazis.com/">Alexandros Eskenazis</a> 研究 Banach 空间中分离网的双 Lipschitz 等价，以及与 <a href="https://sites.google.com/site/dianepeurichard/home">Diane Peurichard</a> 研究集体运动建模。',
    },
